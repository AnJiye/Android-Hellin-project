...
package com.example.hellinproject.posenet
...
import com.example.hellinproject.posenet.*
...
class PosenetActivity :
  ...
  /** Paint class holds the style and color informationom to draw geetries,text and bitmaps. */
